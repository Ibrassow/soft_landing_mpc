...
filename = "data/RP/landing-fuel-comparison/RP_mpc-fuel_optimal_N48-dt1_disturb.csv"
filename2 = "data/RP/landing-fuel-comparison/RP_mpc-landing_error_N48-dt1_disturb.csv"
# Timestep
dt = 1
m0 = 2000
mf = 300
...
[Xs2, Us2, time] = read_data_from_csv(filename2)
print(Xs.shape)
print(Us.shape)
print(time.shape)
print(Xs[:,-1])
...
ax.plot3D(Xs2[1,:].flatten(), Xs2[2,:].flatten(), Xs2[0,:].flatten(), c='b', label="Fuel optimal")
