...
while N != 1:
    ...
    Xcp, Ucp = sl.solve_fuel_optimal(curr_X, landing_target, landing_target, N, verbose=False, solver='ECOS')
...
#save_data_to_csv(Xs, Us, dt, "RP_mpc-fuel_optimal_N48-dt1_disturb.csv")